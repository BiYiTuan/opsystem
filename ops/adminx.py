...
from models import IDC, Host, MaintainLog, HostGroup, AccessRecord, UpdateApp, HostMonitor, LogAnalysis
...
class GlobalSetting(object):
    site_title = u'系统运维管理系统'
    site_footer  = u'DevOps'
...
xadmin.sites.site.register(UpdateApp, UpdateAppAdmin)
xadmin.sites.site.register(HostMonitor, HostMonitorAdmin)
xadmin.sites.site.register(LogAnalysis, LogAnalysisAdmin)
